...
setblock ~3 ~2 ~1 spruce_wall_sign[facing=south]{Text1:"{\"text\":\"Skye\",\"color\":\"gray\"}",Text2:"{\"text\":\"Eggslut\",\"color\":\"gray\"}",Text3:"{\"text\":\"§oshop local\",\"color\":\"dark_purple\"}",Text4:"{\"text\":\"§ocloaca-to-table\",\"color\":\"dark_purple\"}"}
